...
const main = async () => {
  ...
  // New functionality: Log the total amount of tokens being swapped
  const totalTokensSwapped = parseFloat(sellAmount.toString()) / (10 ** decimals);
  console.log(`Total WETH being swapped: ${totalTokensSwapped} WETH`);
